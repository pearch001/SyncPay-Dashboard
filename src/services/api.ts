...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_BASE_URL || 'https://skirts-nearby-trader-repository.trycloudflare.com',
...
export const login = async (
  ...
  const response = await axios.post<AuthResponse>(
    'https://skirts-nearby-trader-repository.trycloudflare.com/api/v1/auth/admin/login',
    { email, password },
    {
      headers: {
        'Content-Type': 'application/json',
